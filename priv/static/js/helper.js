...
$(document).ready(function(){
  ...
  function replaceEmoji(text) {
    return text.replace(emojiRegex, "![emoji](https://assets-cdn.github.com/images/icons/emoji/$1.png)");
  }

  // https://github.com/NextStepWebs/simplemde-markdown-editor/issues/328#issuecomment-227075500
  function attachFileUpload(editor) {
